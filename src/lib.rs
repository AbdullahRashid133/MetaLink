...
#[derive(Debug)]
pub struct MetaLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaLink processing");
    
    let mut processor = MetaLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaLinkProcessor::new(false);
